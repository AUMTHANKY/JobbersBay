                ...
                <div class="row">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "EMAILID">Email id:</label> 
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="EMAILID" name="EMAILID" placeholder="Email Id"   autocomplete="none"/> 
                      </div>
                    </div>
                  </div>  
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      "OTP">OTP:</label> 
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="OTP" name="OTP" placeholder="OTP"   autocomplete="none"/> 
                      </div>
                    </div>
                  </div>  
